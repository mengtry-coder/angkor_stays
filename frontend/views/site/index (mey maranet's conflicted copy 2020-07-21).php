...
<div class="site-index">
    ...
    <div class="list_type">
        <div class="container">
            ...
            <div class="more">
                <a href="<?= Url::toRoute(['accommodation-profile/index']) ?>">Show all Type<i class="fa fa-chevron-right"></i></a>
            </div>
        </div>
    </div>
    <div class="villa_list">
        <div class="container">
            <div class="title">
                ...
                <?php
                    foreach ($acc_promotion as $acc) {
                        // $acc = AccommodationProfile::findOne($row['accommodation_id']);
                       ?>
                              <a href="<?= Url::toRoute(['site/single-acc-type', 'id' => $acc['acc_id'], 'f_from_date' => $f_from_date, 'f_to_date' => $f_to_date, 'guest' => $guest]) ?>">
                                
                           <div class="item">
                                <div class="image">
                                    <img src="<?= $acc['feature_image']; ?>" alt="">
                                </div>
                                <div class="name">
                                    <h2><?= $acc['name']; ?></h2>
                                    <p><i class="fa fa-map-marker"></i>Siem Reap</p>
                                    <p><?= $acc['number_of_rooms']; ?> Rooms, Size: <?= $acc['accommodation_size']; ?></p>
                                    <p>From <span><?= $acc['price']; ?></span>$ / night</p>
                                </div>
                                <div class="discount">
                                    <p>Discount: <?= $acc['promotion'];?> <?= $acc['promotion_type'] == 0 ? "%" : "$";?></p>
                                </div>
                            </div>
                            </a>  
                       <?php
