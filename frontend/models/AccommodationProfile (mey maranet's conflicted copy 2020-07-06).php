...
class AccommodationProfile extends \yii\db\ActiveRecord
{
     ...
     * {@inheritdoc}
     */
    public $number_of_guests, $facility, $daterangepicker;
    public function rules()
    {
        return [
            [['country_id', 'city_id', 'status', 'created_by', 'updated_by', 'accommodation_type', 'star_rating', 'number_of_rooms'], 'integer'],
            [['price'], 'number'],
            [['check_in_time', 'check_out_time', 'created_date', 'updated_date', 'number_of_guests', 'facility', 'daterangepicker'], 'safe'],
            [['accommodation_size', 'description', 'term_condition', 'privacy_policy'], 'string'],
