...
use Yii;
use backend\models\OurService;
use backend\models\OurServiceSearch;
...
/**
 * our serviceController implements the CRUD actions for our service model.
 */
class OurServiceController extends Controller
{
    ...
    /**
     * Displays a single our service model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Creates a new our service model.
    ...
    /**
     * Updates an existing our service model.
    ...
    /**
     * Deletes an existing our service model.
    ...
    /**
     * Finds the our service model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return our service the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
