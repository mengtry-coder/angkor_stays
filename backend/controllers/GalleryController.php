...
/**
 * SlideController implements the CRUD actions for Gallery model.
 */
class GalleryController extends Controller
{
                ...
                if ($model->validate()) {
                    ...
                    foreach ($names as $name) {
                        ...
                        if ($name->saveAs($path.'/'.'_'.$date.'_'.$name->baseName.'.'.$name->extension)) {
                            ...
                            $gallery_id = $model->id;
                            Yii::$app->db->createCommand()->insert('gallery_image', ['file_name'=>$file_name, 'file_path'=>$file_path, 'gallery_id'=>$gallery_id])->execute();
                        }
                    }
                }
                Yii::$app->session->setFlash('success', "Saved successful");
                return $this->redirect('index.php?r=gallery');
    ...
    {   
        ...
        Yii::$app->db->createCommand()->delete('gallery_image', ['gallery_id' => $id])->execute();
