...
/* @var $searchModel backend\models\MealSearch */
...
<h5><?= Html::encode($this->title) ?></h5>
    ...
    <div class="panel"> 
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="pull-right">
                        <button data-target="#demo-default-modal" data-toggle="modal" class="btn btn-success" id="modalButton" value="<?= Url::toRoute(['meal/create']) ?>">                            Add New <i class="fa fa-plus-square go-right"></i>
                        </button> 
                    </div>
                </div>
            </div>
        ...
        <?php
            Modal::begin([
                'header' => ' <h4 class="modal-title">'.'Meals'.'</h4>',
                'id' => 'modal',
                'class' => 'modal fade',
                'size' => 'modal-md',
            ]);
