...
<!-- <h5><?= Html::encode($this->title) ?></h5> -->
    ...
    <div class="panel"> 
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="pull-right">
                        <br>
                        <?php 
                            $total_gallery_row = (new \yii\db\Query())->from('gallery')->count();
                            if ($total_gallery_row >= 6) {
                                echo Html::a('Add New <i class="fa fa-plus-square go-right"></i>', ['gallery/create'], ['class' => 'btn btn-danger', 'style' => 'display: none;']);
                            }else{
                                echo Html::a('Add New <i class="fa fa-plus-square go-right"></i>', ['gallery/create'], ['class' => 'btn btn-danger']);
                            }
                         ?>
                    </div>
                </div>
        ...
        <?php
            Modal::begin([
                'header' => ' <h4 class="modal-title">'.'Galleries'.'</h4>',
                'id' => 'modal',
                'class' => 'modal fade',
                'size' => 'modal-md',
            ]);
