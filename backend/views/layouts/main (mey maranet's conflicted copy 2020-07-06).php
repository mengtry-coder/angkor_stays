                                ...
                                <ul class="navigation-menu">
                                    ...
                                    <li class="has-submenu"> 
                                        ...
                                        <ul class="submenu">
                                            ...
                                            <li>
                                                <a href="<?php echo Yii::getAlias('@web')."/index.php?r=rate/index"; ?>"> Rate</a>
                                            </li> 
                                            <li>
                                                <a href="<?php echo Yii::getAlias('@web')."/index.php?r=rate-plan/index"; ?>"> Rate Plan</a>
                                            </li> 
                                            <li>
