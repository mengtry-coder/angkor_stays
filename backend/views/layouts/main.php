                ...
                <div class="container">
                    ...
                    <div class="topbar-left">
                        <a href="<?php echo Yii::getAlias('@web'); ?>/index.php" class="logo">
                            <img src="<?= CompanyProfile::findOne(1)->feature_image; ?>">
                        </a>
                    </div>
                    <!-- End Logo container-->
                        ...
                        <div class="container">
                            <div id="navigation">
                                ...
                                <ul class="navigation-menu">
                                    ...
                                    <li>
                                        <a href="<?php echo Yii::getAlias('@web'); ?>/index.php?r=accommodation-profile"> <i class="fa fa-bed"></i>Accommodation</a>
                                    </li>  
                                    ...
                                    <li>
                                        <a href="<?php echo Yii::getAlias('@web')."/index.php?r=allotment/index"; ?>"> <span><i class="fa fa-calendar-check-o"></i> Booking Engine</span> </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo Yii::getAlias('@web')."/index.php?r=reservation/index"; ?>"> <span><i class="fa fa-calendar"></i> Reservation</span> </a>
                                    </li>
                                    
                                    <li class="has-submenu"> 
                                        <a href="#"><span> <i class="fa fa-id-card-o"></i> Setup</span> </a>
                                        <ul class="submenu">
                                            <li>
                                                <a href="<?php echo Yii::getAlias('@web')."/index.php?r=reservation/index"; ?>"> Reservation</a>
                                            </li> 
                                            <li>
                                                <a href="<?php echo Yii::getAlias('@web')."/index.php?r=custom-field/index"; ?>"> Custom Field</a>
                                            </li> 
                                            <li>
                                                <a href="<?php echo Yii::getAlias('@web')."/index.php?r=service/index"; ?>"> Service</a>
                                            </li>
                                            <li>
                                                <a href="<?php echo Yii::getAlias('@web')."/index.php?r=accommodation-type/index"; ?>"> Accommodation Type</a>
                                            </li>    
                                            <li>
                                                <a href="<?php echo Yii::getAlias('@web')."/index.php?r=facility/index"; ?>"> Facility</a>
                                            </li>  
                                            <li>
                                                <a href="<?php echo Yii::getAlias('@web')."/index.php?r=sport/index"; ?>"> Sport</a>
                                            </li>  
                                            <li>
                                                <a href="<?php echo Yii::getAlias('@web')."/index.php?r=transportation/index"; ?>"> Transportation</a>
                                            </li>  
                                             <li>
                                                <a href="<?php echo Yii::getAlias('@web')."/index.php?r=meal/index"; ?>"> Meal</a>
                                            </li> 
                                            <li>
                                                <a href="<?php echo Yii::getAlias('@web')."/index.php?r=season-type/index"; ?>"> Season Type</a>
                                            </li> 
                                        </ul>
                                    </li>
                                    <li class="has-submenu"> 
                                        <a href="#"><i class="fa fa-bars" aria-hidden="true"></i> <span> MISC</span> </a>
                                        <ul class="submenu">
                                            <li>
                                                <a href="<?php echo Yii::getAlias('@web')."/index.php?r=user"; ?>">User Management</a>
                                            </li>
                                            <li>
